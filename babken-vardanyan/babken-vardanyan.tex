...
\usepackage[left=3.0cm, right=3.0cm, top=4.0cm, bottom=4.0cm]{geometry}
% Custom links
\usepackage{hyperref}
...
\titlespacing{\section}{0pt}{8.0pt}{5.0pt}
...
\par{\centering{\Large Web Developer}\bigskip\par}
...
\begin{itemize}
\item Dignio, \textbf{Developer}, \site{https://www.dignio.com}{www.dignio.com} (Aug 2018 - Present)
\item Overpass, \textbf{Lead Developer}, \site{https://app.getoverpass.com}{app.getoverpass.com} (Sep 2017 - Jul 2018)
\item Basic IT Center, \textbf{Instructor}, \site{https://it-center.am}{it-center.am} (Sep 2017 - Feb 2018)
\item SFL LLC, \textbf{Backend Developer}, \site{https://callmonkey.com}{callmonkey.com} (May 2015 - June 2017)
...
\begin{itemize}
\item Python developer at Dignio, a Norwegian Healthcare Web Application. Working with a large team of Russian freelancers:\\
	\site{https://www.dignio.com}{https://www.dignio.com}
...
\begin{itemize}
	...
	\item Russian (Excellent)
	\item German (Written only)
	\item Georgian (Beginner)
\end{itemize}
