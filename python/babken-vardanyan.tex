...
\begin{itemize}
\item Overpass, \textbf{Lead Developer}, \site{app.getoverpass.com}{app.getoverpass.com} (Sep 2017 - Present)
\item Basic IT Center, \textbf{Programming Instructor}, \site{it-center.am}{it-center.am} (Sep 2017 - Present)
\item SFL LLC, \textbf{Java Developer}, \site{callmonkey.com}{callmonkey.com} (May 2015 - June 2017)
\item Unibank CJSC, \textbf{Security Administrator}, \site{unibank.am}{unibank.am} (May 2014 - May 2015)
\end{itemize}
